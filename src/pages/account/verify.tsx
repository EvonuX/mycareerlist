...
const verify = () => {
  return (
    <Layout>
      <SEO title="Verify your login" noindex />

      <SimpleGrid cols={2} breakpoints={[{ maxWidth: 768, cols: 2 }]}>
        <Box>
          <Title mb="md">Check your email address</Title>
          <Text>An email containing a login link has been sent.</Text>
        </Box>
